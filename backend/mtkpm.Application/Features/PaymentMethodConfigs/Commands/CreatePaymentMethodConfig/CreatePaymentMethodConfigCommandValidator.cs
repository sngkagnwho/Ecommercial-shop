...
{
    public class CreatePaymentMethodConfigCommandValidator : AbstractValidator<CreatePaymentMethodConfigCommand>
    {
        public CreatePaymentMethodConfigCommandValidator()
        {
            RuleFor(x => x.Dto.Code)
                .NotEmpty().WithMessage("Mã ph??ng th?c thanh toán là b?t bu?c")
                .MaximumLength(50).WithMessage("Mã ph??ng th?c thanh toán không v??t quá 50 ký t?");
