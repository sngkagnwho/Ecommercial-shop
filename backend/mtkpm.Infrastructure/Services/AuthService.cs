...
namespace mtkpm.Infrastructure.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<AuthResponse> RegisterAsync(RegisterDto request, string? ipAddress = null, string? deviceInfo = null)
        {
            ...
            {
                return AuthResponse.FailureResult($"Email '{request.Email}' ?ã ???c ??ng ký", 
            ...
            {
                return AuthResponse.FailureResult($"Tên ng??i dùng '{request.UserName}' ?ã ???c s? d?ng",
            ...
            if (!result.Succeeded)
            {
                ...
                return AuthResponse.FailureResult("??ng ký th?t b?i", errors);
            }
        ...
        public async Task<AuthResponse> LoginAsync(LoginDto request, string? ipAddress = null, string? deviceInfo = null)
        {
            ...
            if (user == null)
            {
                return AuthResponse.FailureResult("Thông tin ??ng nh?p không chính xác",
                    new List<string> { "Invalid credentials" });
            }

            if (user.IsDeleted)
            {
                return AuthResponse.FailureResult("Tài kho?n ?ã b? xóa",
            ...
            {
                return AuthResponse.FailureResult("Tài kho?n ?ã b? khóa",
        ...
        public async Task<AuthResponse> RefreshTokenAsync(RefreshTokenDto request, string? ipAddress = null, string? deviceInfo = null)
        {
            ...
            if (userId == null)
            {
                return AuthResponse.FailureResult("Token không h?p l?",
            ...
            {
                return AuthResponse.FailureResult("Ng??i dùng không t?n t?i",
            ...
            {
                return AuthResponse.FailureResult("Refresh token không h?p l?",
