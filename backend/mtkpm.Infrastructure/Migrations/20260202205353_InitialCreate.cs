...
namespace mtkpm.Infrastructure.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "97a7c8dd-35bc-4bdf-88a3-ed73114caf84", "Admin", "ADMIN" },
                    { 2, "eb144287-9803-4ee2-8469-5228e758a5c2", "User", "USER" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavouriteProducts_UserId_ProductId",
                table: "FavouriteProducts",
                columns: new[] { "UserId", "ProductId" },
                unique: true);
